...
1.Created a database using SQLite and the tables User, Habit, and Habit Enroll were created if they don't exist. This was done using the ADO.NET and SQLite libraries.
...
3.SQLite commands were used to perform CRUD operations, with some challenges in working with foreign key constraintss.
