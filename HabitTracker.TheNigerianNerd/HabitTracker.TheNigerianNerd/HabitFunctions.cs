...
internal class HabitFunctions
{
    private string ConnectionString;
    public HabitFunctions(string connectionString) 
    { 
        ConnectionString = connectionString;
    }

    internal int[] GenerateRandomQuantities(int count, int min, int max)
    {
    ...
    internal string[] GenerateRandomDates(int count)
    {
    ...
    internal bool IsTableEmplty(string tableName)
    {
        using (var connection = new SqliteConnection(ConnectionString))
        {
            connection.Open();
