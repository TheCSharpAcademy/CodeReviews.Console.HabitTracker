...
{
    [FeaturesMetadata(Name: "Delete Habits", Description: "Provide UI for deleting habits.")]
    [FeaturesCategory("Delete")]
    public class DeleteHabits : Features
    {
        public override void Setup()
        {
            ...
            tableView.CellActivated += (e) => {
                ...
                if (delete == 0)
                {
                    ...
                    tableView.Table = connection.ExecuteDbCommand("ViewHabits");
