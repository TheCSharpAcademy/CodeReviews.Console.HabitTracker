...
A habit tracker used to track uses habits, allowing them create
habits and enter input for them daily.
...
where you'll explain how your app works.
...
* **SQLITE database connection**
    ...
    -Once the User creates the Table, the will be prompted
to select a table for the remaining operations
...
* **CRUD DB functions**
    ...
    -The user can insert into a habit with option "2" 
from the table selected at start up
