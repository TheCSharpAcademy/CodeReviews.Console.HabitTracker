...
This is a very simple app that uses ADO .NET and SQLite database.
It has very simple SQL commands. 
...
- The C# Academy
- StackOverflow
- MS docs for SQLite with C#
- Zetcode basics of SQLite with C#