...
`Advanced` Requirments:
    ...
    1 Try using parameterized queries to make your application more secure
    2 Let the users create their own habits (with their own unit) to track.
    3 Seed Data when DB gets created 1st time, inserting a 100 records.
